...
public:
	...
	/*
		...
		Enqueue function needs to be able to return anything, as it does not know the return type of the 
		function it is adding to queue.Thus we are using auto.
	*/
...
-> std::future<typename std::result_of<F(Args...)>::type>
{
	...
	//packaged task wraps function pointer with parameters and can be used call function
