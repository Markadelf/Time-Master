...
public:
	...
	void LoadMaterial(int vHandle, int pHandle, const char* materailName, const char* texture_albedo_filepath, const char* texture_roughness_filepath, const char* texture_normal_filepath);
